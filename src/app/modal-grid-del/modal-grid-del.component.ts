...
@Component({
  selector: 'app-modal-grid-del',
  templateUrl: './modal-grid-del.component.html',
  styleUrls: ['./modal-grid-del.component.css']
})
export class ModalGridDelComponent implements OnInit {
